...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-02-2023 a las 20:40:21
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='versión demo para la bitácora solo permite una foto';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='tabla diseño demo contiene las direciones de los diceños';
...
--
-- Estructura de tabla para la tabla `seccionusuario`
--
...
CREATE TABLE `seccionusuario` (
  ...
  `fechaUltimaSeccion` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='versión demo tabla tarea';
...
CREATE TABLE `usuario` (
  ...
  `fotografiaId` int(7) NOT NULL DEFAULT 1 COMMENT 'índice en la tabla imagen',
  `emailUsuario` int(25) NOT NULL COMMENT 'email empresarial',
  `rol` varchar(20) NOT NULL COMMENT 'rol de desempeño dentro de la empresa'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='version demo de la tabla usuario';
...
--
-- Indices de la tabla `seccionusuario`
--
ALTER TABLE `seccionusuario`
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fotografiaId` (`fotografiaId`);
...
--
-- Filtros para la tabla `seccionusuario`
--
ALTER TABLE `seccionusuario`
  ADD CONSTRAINT `seccionusuario_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`codigoUsuario`) ON UPDATE CASCADE;
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`fotografiaId`) REFERENCES `foto` (`idFoto`) ON UPDATE CASCADE;
COMMIT;
